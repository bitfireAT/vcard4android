...
object PhoneNumberHandler: DataRowHandler() {
    ...
    override fun handle(values: ContentValues, contact: Contact) {
        ...
        when (values.getAsInteger(Phone.TYPE)) {
            ...
            Phone.TYPE_CALLBACK ->
                tel.types += Contact.PHONE_TYPE_CALLBACK
            Phone.TYPE_CAR ->
                tel.types += TelephoneType.CAR
            Phone.TYPE_COMPANY_MAIN ->
                tel.types += Contact.PHONE_TYPE_COMPANY_MAIN
            Phone.TYPE_ISDN ->
            ...
            Phone.TYPE_OTHER_FAX ->
                tel.types += TelephoneType.FAX
            Phone.TYPE_RADIO ->
                tel.types += Contact.PHONE_TYPE_RADIO
            Phone.TYPE_TELEX ->
            ...
            Phone.TYPE_ASSISTANT ->
                tel.types += Contact.PHONE_TYPE_ASSISTANT
            Phone.TYPE_MMS ->
                tel.types += Contact.PHONE_TYPE_MMS
            Phone.TYPE_CUSTOM -> {
