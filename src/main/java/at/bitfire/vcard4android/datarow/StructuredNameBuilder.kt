...
class StructuredNameBuilder(mimeType: String, dataRowUri: Uri, rawContactId: Long?, contact: Contact)
    ...
    object Factory: DataRowBuilder.Factory<StructuredNameBuilder> {
        ...
        override fun newInstance(dataRowUri: Uri, rawContactId: Long?, contact: Contact) =
            StructuredNameBuilder(mimeType(), dataRowUri, rawContactId, contact)
    }
